...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const res = await nft.methods.tokenURI(5).call()
  ...
  constructor(props) {
    ...
    this.bottomConsoleText="";
  }

  updateBottomConsole = (c) => {
    this.bottomConsoleText=c
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <Injector updtBC={this.updateBottomConsole}/>
        <div id="bottomConsole">{this.bottomConsoleText}</div>
      </div>
    );
  }
}
...
//addr=0xA0A5bb7B563461A586C1bd6D635Ba9Fde7315008&data=[["lips","Strip"],[["util","Group"],[[["lips","Top"],{c},[]],[["lips","Bar"],{c},[]],[["lips","Board"],{c},[]]],[]],[]]
