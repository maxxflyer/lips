...
import NFT721metadata from './../NFT721metadata/NFT721metadata';
import Web3 from 'web3';
import './css.css';
class NFT721sheet extends Component {
    constructor(props) {
        super(props)
        this.state = { ipfs: '' , account: '' , thisM :[]}
    ...
    render(){
        ...
        return (
<>
            <NFTdisplay updtLandscape={this.props.updtLandscape} contract={this.props.data[1]} id={id}/>           
            <NFT721metadata updtLandscape={this.props.updtLandscape} contract={this.props.data[1]} id={id}></NFT721metadata> 
            </>
        ); 
    }
